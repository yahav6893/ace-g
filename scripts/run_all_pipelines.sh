...
# We will run both configs
CONFIGS=("DINOv2_vitl_reg.yaml")

for CONFIG_NAME in "${CONFIGS[@]}"; do
    echo "=========================================================="
    echo " Starting Pipeline for Config: ${CONFIG_NAME} on all scenes"
    echo "=========================================================="

    export WANDB_RUN_ID="$(python -c 'import wandb; print(wandb.util.generate_id())')"
    export WANDB_RESUME="allow"

    TRAIN_STATUS_NAME="auto_pipeline_status_${CONFIG_NAME}.json"
    STATUS_JSON_PATH="${OUTPUT_ROOT}/train_status/${TRAIN_STATUS_NAME}"

    echo ">>> STAGE 1: TRAINING [${CONFIG_NAME}]"
    ...
    echo ">>> STAGE 2: REGISTRATION & EVALUATION [${CONFIG_NAME}]"
    ...
    echo ""
    echo ">>> Completed Pipeline for ${CONFIG_NAME}!"
    echo "=========================================================="
done
